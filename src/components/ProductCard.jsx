...
export default function ProductCard({ product, hasDiscount, welcomeDiscount, addToCart }) {
  return (
    <div className="bg-gradient-to-br from-gray-900 to-black border border-red-900 rounded-xl shadow-lg overflow-hidden hover:shadow-2xl hover:border-red-600 transition-all">
            ...
            {hasDiscount ? (
              <div>
                ...
                <span className="text-red-600 font-bold text-xl ml-2">
                  ${(product.price * (1 - welcomeDiscount / 100)).toFixed(2)}
                </span>
              </div>
            ) : (
